                            ...
                            <div class="row">
                                <div class="col-md-1">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control example-date-input" name="invoice_no" type="text"
                                            id="invoice_no" value="{{ $invoice_no }}" readonly style="background-color: #ddd">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        ...
                                        <input type="submit" class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"
                                            value="Add More">
                                    </div>
                                </div>
                            </div>
