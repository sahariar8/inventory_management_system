                    ...
                    <div class="card-body">
                      ...
                      <form action="{{ route('customer.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-sm-9">
                                <img class="rounded avatar-lg" id="showImage" src="{{ !empty($customer->image) ? asset($customer->image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-rounded btn-primary d-flex justify-content-end">Update Customer</button>
                      </form>
                    </div>
                </div>
            </div>
