                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="invoice-title">
                                <h4 class="float-end font-size-16"><strong>Invoice No # {{ $invoice->invoice_no }}</strong>
                                </h4>
                                <h3>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="no-line text-end">${{ $payment->discount_amount ?  $payment->discount_amount : '0.0' }}</td>
                                                </tr>
                                                 <tr>
                                                    <td class="no-line"></td>
                                                     <td class="no-line"></td>
