            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Reset Password | Admin</b></h4>
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" id="email" name="email" type="email" required="" placeholder="Email" value="{{ old('email') }}">
                                        @error('email')
